...
export const setAccessToken = (accessToken) => {
  Cookies.set(TOKEN_KEY, accessToken, {expires: config.cookieExpires || 1})
}
...
const hasAccess = (roles, route) => {
  if (route.meta && route.meta.access) return hasOneOf(roles, route.meta.access)
  else return true
}
 ...
 */
export const accessDecide = (name, roles, routes) => {
